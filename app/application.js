...
function draw(context2d, generation, totalGeneration) {
  ...
  if(totalGeneration > 0)
    setTimeout(update, 10, context2d, generation, totalGeneration);
}
...
function update(ctx, generation, totalGeneration) {
  ...
  setTimeout(draw, 10, ctx, nextGeneration, totalGeneration - 1);
}

(function() {
  var generation = createGeneration(200, 200);
